...
var fng1 = "test1_6.glb" , fng2 = "test2_4.glb";
var fr = 1;
var offY = 0;
var zw = 50;
var jios = 0;
...
class Banner1 extends Component {
  componentDidMount() {
    ...
    var divh1;
    adjustOnResize();
    var mm1 = document.getElementById("mazter1");
    var mm2 = document.getElementById("mazter2");
    var mm3 = document.getElementById("mazter3");
    var dmm = 0;

    var isRenderStarted = false;
    var cint = 0;
    var animate = function () {
      ...
      if(window.scrollY < h/2) {
       ...
       var mmc1 = document.getElementById("master_container");
        if(mmc1.offsetTop > 0){
          dmm = mmc1.offsetTop - window.scrollY;
        }
      }
      ...
      if(window.scrollY < h*.6 ){
        ...
        divh1 = document.getElementById("story_img1").offsetHeight;
      ...
      <div >
        ...
        <div id="storyDiv" className = "storyDiv" >
          <div className="storyDiv_left">
            <center>
              <img src="b1.png" id="story_img1" />
              <img src="mission.png" id="mission_img" />
              <img src="vision.png" id="vision_img" />
            </center>
          </div>
          <div className="storyDiv_right">
            <center>
              <img src="b2.jpg" id="story_img2" />
            </center>
          </div>
        </div>
      </div>
...
function adjustOnResize(){
  ...
  mw = document.getElementById("mission_img").offsetWidth;
  divh1 = document.getElementById("story_img1").offsetHeight;
